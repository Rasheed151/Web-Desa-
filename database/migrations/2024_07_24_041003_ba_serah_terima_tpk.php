...
return new class extends Migration
{
    ...
    {
        Schema::create('ba_serah_tpk', function (Blueprint $table) {
            $table->increments('id'); 
            ...
            $table->date('tgglDes'); // Tanggal SK Kades
            ...
            $table->date('tgglTus'); // Tanggal Keputusan
    ...
    {
        Schema::dropIfExists('ba_serah_tpk');
    }
};
