...
return new class extends Migration
{
    ...
    {
        Schema::create('surat_perintah_kerja_beliLgsng', function (Blueprint $table) {
            $table->increments('id'); 
            ...
            $table->string('jabatanPka'); // Jabatan PKA
            $table->string('namaPenyedia'); // Nama Penyedia 
            $table->string('namaPerusahaan'); // Nama Perusahan/Pemasok/Toko
    ...
    {
        Schema::dropIfExists('surat_perintah_kerja_beliLgsng');
    }
};
